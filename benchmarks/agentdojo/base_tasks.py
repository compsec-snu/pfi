...
class BaseUserTask(abc.ABC, Generic[Env]):
    ...
    TASK_TYPE: Literal["EXPLICIT_CONTROL_FLOW", "IMPLICIT_FLOW", "EXPLICIT_DATA_FLOW", "NO_FLOW", "PROMPT_INJECTION", "DATA_INJECTION"] = None
    """The type of the task. This is used to determine the type of the task in the task suite."""
    DATA_INJECTION_PROMPT: str = None
...
class BaseInjectionTask(abc.ABC, Generic[Env]):
    ...
    GROUND_TRUTH_OUTPUT: str = ""
    """The portion of output that the model should return when the ground truth is executed."""
    TASK_TYPE: Literal["PROMPT_INJECTION", "DATA_INJECTION"] = None
    """The type of the injection task."""
