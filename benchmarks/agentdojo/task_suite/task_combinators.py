...
from functions_runtime import FunctionCall, TaskEnvironment
...
class TaskCombinator(Generic[TASK, ENV]):
    ...
    def create_combined_task(
        ...
        class NewCombinedTask(task_type):
            ...
            if prompt is not None or user_task_1.TASK_TYPE == "EXPLICIT_CONTROL_FLOW" or user_task_2.TASK_TYPE == "EXPLICIT_CONTROL_FLOW":
                TASK_TYPE = "EXPLICIT_CONTROL_FLOW"
            elif user_task_1.TASK_TYPE == "IMPLICIT_FLOW" or user_task_2.TASK_TYPE == "IMPLICIT_FLOW":
                TASK_TYPE = "IMPLICIT_FLOW"
            elif user_task_1.TASK_TYPE == "EXPLICIT_DATA_FLOW" or user_task_2.TASK_TYPE == "EXPLICIT_DATA_FLOW":
            ...
            DATA_INJECTION_PROMPT = user_task_1.DATA_INJECTION_PROMPT
